...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/epms? useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia" + "/Shanghai");
