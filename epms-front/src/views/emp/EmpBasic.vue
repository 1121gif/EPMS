    ...
    <div style="display: flex;justify-content: space-between">
      ...
      <div>
        ...
        <el-button
            ...
            @click="showAddEmpView">添加员工</el-button>
      ...
      <div v-show="showAdvanceSearchView"
        ...
        <el-row style="margin-top: 10px">
          ...
          <el-col :span="5" :offset="4">
            <el-button size="mini" @click="dataClear">取消</el-button>
...
export default {
  ...
  methods: {
    ...
    dataClear() {
      this.loading = true;
      let url = '/employee/basic/?currentPage=' + this.currentPage + '&size=' + this.size + '&name=' + '';
      this.getRequest(url).then(resp => {
        this.loading = false;
        if (resp) {
          this.emps = resp.data;
